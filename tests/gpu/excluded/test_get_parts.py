# This test file is used to verify the correctness of the GPU version of get_parts function
# Now we fall back to the original CPU implementation of get_parts function, so this test file is not used for now
